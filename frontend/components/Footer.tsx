        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/about" className="text-zinc-400 hover:text-white transition-colors inline-flex items-center">
                  About Us
              ...
              <li>
                <Link href="/pricing" className="text-zinc-400 hover:text-white transition-colors inline-flex items-center">
                  Pricing
                  <ArrowUpRight className="ml-1 h-3 w-3" />
                </Link>
              </li>
              <li>
                <Link href="/docs" className="text-zinc-400 hover:text-white transition-colors inline-flex items-center">
                  Documentation
                  <ArrowUpRight className="ml-1 h-3 w-3" />
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/blog" className="text-zinc-400 hover:text-white transition-colors inline-flex items-center">
                  Blog
                  <ArrowUpRight className="ml-1 h-3 w-3" />
                </Link>
              </li>
              <li>
                <Link href="/case-studies" className="text-zinc-400 hover:text-white transition-colors inline-flex items-center">
                  Case Studies
                  <ArrowUpRight className="ml-1 h-3 w-3" />
                </Link>
              </li>
              <li>
                <Link href="/support" className="text-zinc-400 hover:text-white transition-colors inline-flex items-center">
                  Support
                  <ArrowUpRight className="ml-1 h-3 w-3" />
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-zinc-400 hover:text-white transition-colors inline-flex items-center">
                  Contact
                  <ArrowUpRight className="ml-1 h-3 w-3" />
                </Link>
              </li>
